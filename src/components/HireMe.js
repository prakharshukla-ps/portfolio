...
const HireMe = () => {
	return (
		<div className="fixed left-0 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-2 md:bottom-auto md:absolute sm:right-0">
