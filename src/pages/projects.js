...
const projects = () => {
	return (
		<>
			<Head>
				<title>Prakhar Shukla | Projects</title>
				<meta
					name="description"
					content="Explore Prakhar Shukla's portfolio of projects, showcasing expertise in React.js, React Native, and modern web technologies. Discover innovative solutions and real-world applications built with passion and precision."
				/>
			</Head>
			...
			<main className="flex w-full flex-col items-center justify-center dark:text-light">
				<Layout classname="pt-16 sm:py-20">
					<AnimatedText
						text="Imagination Trumps Knowledge!"
						className="!text-7xl !mb-16 lg:!text-6xl sm:!text-5xl xs:!text-3xl sm:!mb-12"
					/>

					<div className="grid grid-col-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-y-12 sm:gap-x-0">
